    ...
    <div className="flex h-screen flex-col gap-6  w-screen justify-center max-sm:h-fit">
      ...
      <div className="w-full max-w-sm ml-5 max-sm:p-3 max-sm:max-w-80">
        ...
        <select
          ...
          id="countries"
          className="bg-gray-50 border  text-sm rounded-lg  block w-full p-2.5 dark:bg-gray-700 border-gray-600 placeholder-gray-400 text-gray-300 focus:ring-blue-500 focus:border-blue-500"
        >
